...
def setup_product():
    ...
    import Products.jobDescription
    zcml.load_config('configure.zcml', Products.jobDescription)
    ...
    ztc.installPackage('Products.jobDescription')
...
setup_product()
ptc.setupPloneSite(products=['Products.jobDescription'])

...
def setup_product():
    ...
    import collective.nutritionfacts
    zcml.load_config('configure.zcml', collective.nutritionfacts)
    ...
    ztc.installPackage('collective.nutritionfacts')
...
setup_product()
ptc.setupPloneSite(products=['collective.nutritionfacts'])

(function($) { $(function() {
    ...
    $(content).find('*').not('.comment > h3').not('.documentActions > h2').not('#addthis > h2').filter(function() { return /^h[1234]$/.test(this.tagName.toLowerCase()) })

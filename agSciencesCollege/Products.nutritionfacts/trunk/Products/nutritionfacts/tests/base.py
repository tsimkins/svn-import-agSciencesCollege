...
def setup_product():
    ...
    import Products.nutritionfacts
    zcml.load_config('configure.zcml', Products.nutritionfacts)
    ...
    ztc.installPackage('Products.nutritionfacts')
...
setup_product()
ptc.setupPloneSite(products=['Products.nutritionfacts'])

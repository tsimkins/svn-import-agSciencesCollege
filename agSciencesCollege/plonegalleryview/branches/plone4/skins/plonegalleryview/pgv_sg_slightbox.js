...
var Lightbox = new Class({
	...
	buildbox : function () {
		...
		this.close = new Element('a').setProperties({id: 'lbCloseLink', href: '#'}).injectInside(this.image).onclick = this.overlay.onclick = this.close.bind(this);
...
var lightboxforsmoothgallery = Lightbox.extend({
	...
	nextEffect: function() {
		...
		case 1:
            ...
            this.fullsizeLink.setProperty('href', this.images[this.activeImage].imagepath.replace('_galleryzoom', ''));

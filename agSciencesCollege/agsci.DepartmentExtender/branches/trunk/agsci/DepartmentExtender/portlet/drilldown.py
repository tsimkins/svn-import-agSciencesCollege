...
class TypesVocabulary(object):
    ...
    def __call__(self, context):
        return SimpleVocabulary([
            SimpleTerm('department_research_areas', title="Research Areas"),
        ])
...
class IDrilldown(IPortletDataProvider):
    ...
    drilldown_type = schema.Choice(
            ...
            required=False,
            vocabulary='agsci.DepartmentExtender.portlet.drilldown.types'
    )
...
class Renderer(TagsRenderer):
    ...
    def obj_tags(self):
        return {
            'department_research_areas' : 'department_research_areas',
        }.get(self.data.drilldown_type, 'unknown')

    @property 
    def target_view(self):
        return {
            'department_research_areas' : 'research-areas',
        }.get(self.data.drilldown_type, 'unknown')
...
class AddForm(base.AddForm):
    ...
    description = _(u"This portlet displays drilldown information for custom fields.")
